...
proc create_root_design { parentCell } {
  ...
  # Create instance: FFTBRNC_0, and set properties
  set FFTBRNC_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:FFTBRNC:1.0 FFTBRNC_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_IMPORT_BOARD_PRESET {C:/Users/Rahul Sridhar/Desktop/.tcl} \
  ...
  connect_bd_intf_net -intf_net FFTBRNC_0_M00_AXIS [get_bd_intf_pins FFTBRNC_0/M00_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins FFTBRNC_0/S00_AXIS] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins FFTBRNC_0/m00_axis_aresetn] [get_bd_pins FFTBRNC_0/s00_axis_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins FFTBRNC_0/m00_axis_aclk] [get_bd_pins FFTBRNC_0/s00_axis_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins smartconnect_0/aclk]
